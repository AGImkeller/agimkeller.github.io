...
<div class="column is-5-desktop is-8-tablet">
 <div class="card">
     <div class="card-content">
        <div class="content">
             <b>Immune receptor interactions</b>
        </div>
    </div>
    <div class="card-image">
        <img src="/img/science/tcr_mhci_small.png" 
            width="170" height="170" style="margin:0px 20px 20px 20px" />
        <img src="/img/science/tcr_mhcii_small.png" 
            width="170" height="170" style="margin:0px 20px 20px 20px" />
    </div>
</div>
</div>
